...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"\\vue-demo1\\src\\main\\java");         //自定义代码生成后的存放目录
        gc.setAuthor("1Han");                            //设置项目作者
...
//        pc.setModuleName("test");                             //指定生成的模块名称
        pc.setParent("com.han");                            //设置模块中的父目录名
